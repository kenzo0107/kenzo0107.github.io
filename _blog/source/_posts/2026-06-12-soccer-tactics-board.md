...
このページの話はこういう動き方になるよ、と言って何回か繰り返してみると「あーなるほど！」と言ってくれる様になりました。
そして、自分のスマホでも触り始め、友人とこんな作戦どう？と話す時に使っていて、良い展開だなと思いました。

## おわりに

「同時に動かす」「何度でも繰り返す」「軌跡を残す」という、物理の作戦盤では難しかった点を解決したくて作りました。子供への説明はもちろん、チームの戦術共有やトレーニングメニューの記録にも使えました。
